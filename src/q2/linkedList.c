...
listElement* createEl(char* data, size_t size) {
	...
	strcpy(dataPointer, data);  // Copy the string pointed to by data, to dataPointer
...
listElement* insertAfter(listElement* el, char* data, size_t size) {
	listElement* newEl = createEl(data, size);  // Create a new element (method above)
...
void push(listElement** head, char* data, size_t size) {
	listElement* elementToPush = createEl(data, size);  // Create the element to be pushed, from th einput parameters
...
void enqueue(listElement** head, char* data, size_t size) {
	listElement* elementToQueue = createEl(data, size);  // Create the element to be pushed, from th einput parameters
